$(document).ready(function (e) {
  var table = $("#myTable").DataTable({
    ...
    columns: [
      {
        title: " #",
        className: "text-center border-l  border-[#D9D9D9]",
      },
      {
        title: "العنوان",
        className: "text-center  border-l  border-[#D9D9D9]",
      },
      { title: "الوصف", className: "text-center border-l border-[#D9D9D9]" },
      { title: "استعراض", className: "text-center border-[#D9D9D9]" },
    ],
    language: {
      search: "",
    ...
    ordering: false,
    info: false,
    dom: "<''<'top flex justify-between   mb-3 mx-5 flex-wrap  mt-10' <'div1'><'div2'> <'block mt-3'l>><'kk  m-5 '> <'relative  w-full mx-auto  overflow-x-auto  w-full 'rt>><'bottom flex relative botton-1 py-4 rounded-b-xl w-full bg-white border-b mx-4 ' <'mx-auto mt-2     custom-page-number' p>>",
    createdRow: function (row, data, dataIndex) {
      $("td:eq(3)", row).html(
        `       <div>
                                <button type="button"
                                    class="   bg-[#E1A123] border font-semibold text-white  hover:bg-black duration-500 focus:ring-4 focus:ring-blue-300  rounded-lg text-sm px-5 py-2.5 mr-2   dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                    ملف</button>
  ...
  $("#myTable_wrapper").css("overflow", "hidden");
  ...
  $(".div1").html(`
            <div class="text-right">
                                    ...
                                    <a
                                        class="text-[#0D0C22] transition-colors text-right  duration-200 dark:text-gray-200  dark:hover:text-blue-400   ">1</a>
                                </div>
  `);
  $(".kk").html(`
            <div class="text-right">
                                    ...
                                    <a
                                        class="text-[#0D0C22] transition-colors text-right  duration-200 dark:text-gray-200  dark:hover:text-blue-400   ">ما علاقة الخطة بسير جديد للقضية؟</a>
                                </div>
  `);
...
$(document).ready(function (e) {
  ...
  var table2 = $("#myTable2").DataTable({
    ...
    columns: [
      { title: "#", className: "w-[3%]" },
      { title: " الاجراء ", className: "w-[30%]" },
      { title: "عدد المرفقات", className: "w-[25%]" },
      { title: "التفاصيل", className: "w-[25%]  " },
    ],
    ordering: false,
    info: false,
...
$(document).ready(function (e) {
  ...
  var table2 = $("#myTable3").DataTable({
    ...
    columns: [
      { title: "#", className: "w-[5%]" },
      { title: " الخطة ", className: "w-[70%] text-right" },
    ],
    ordering: false,
    info: false,
