$(document).ready(function (e) {
  var table = $("#myTable1").DataTable({
    ...
    ordering: false,
    info: false,
    dom: "<''<'top flex sm:justify-between  text-center mb-3 mx-2 flex-wrap sm:flex-nowrap'    <'block relative mt-1 divsearch 'f> <'block'l> ><'relative  w-full mx-auto  overflow-x-auto border border-solid border-[#E5E5E5]'rt>><'bottom flex relative botton-1 py-4 rounded-b-xl w-full bg-white border-b mx-4 ' <'ml-auto mt-2     custom-page-number' p>>",
  });
