  ...
  var table = $("#myTable").DataTable({
    ...
    createdRow: function (row, data, dataIndex) {
      ...
      $("td:eq(5)", row).html(
        `       <div>
                                <button type="button"
                                    class="w-full  but  border-[#8C7155] text-[#8C7155] border   hover:bg-black duration-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mt-3  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                    الجلسة</button>
