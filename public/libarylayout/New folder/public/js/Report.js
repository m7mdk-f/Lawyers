$(document).ready(function (e) {
  ...
  var table = $("#myTable").DataTable({
    ...
    columns: [
      ...
      { title: " اسم الاشتراك" },
      { title: "المكتب", className: "text-right" },
      { title: "مدة الاشتراك", className: "text-right" },
      { title: "سعر الاشتراك", className: "text-right" },
      { title: "تاريخ بدء الإشتراك", className: "text-right" },
      { title: "تاريخ إنتهاء الإشتراك", className: "text-right" },
    ],
    ordering: false,
    info: false,
  ...
  h1.innerText = "المكاتب المنضمة لنا";
