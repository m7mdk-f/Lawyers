$(document).ready(function (e) {
  ...
  var table = $("#myTable").DataTable({
    ...
    columns: [
      ...
      { title: " رقم المكتب", className: "w-[10%] " },
      { title: "اسم المكتب", className: "text-right" },
      { title: "تاريخ بدء الاشتراك" },
...
<path d="M19.9966 17C17.1667 17 14.6733 19.0096 14.0118 21.6428C13.987 21.7415 14.0016 21.8463 14.0522 21.934C14.1029 22.0217 14.1855 22.0852 14.2818 22.1106C14.3781 22.1359 14.4804 22.121 14.566 22.0691C14.6516 22.0172 14.7136 21.9326 14.7383 21.8339C15.3083 19.5649 17.5165 17.7684 19.9966 17.7684C22.4767 17.7684 24.6918 19.5655 25.2617 21.8339C25.2864 21.9326 25.3484 22.0172 25.434 22.0691C25.5196 22.121 25.6219 22.1359 25.7182 22.1106C25.8145 22.0852 25.8971 22.0217 25.9478 21.934C25.9984 21.8463 26.013 21.7415 25.9882 21.6428C25.3266 19.0089 22.8265 17 19.9966 17ZM20.0005 19.049C18.6705 19.049 17.5845 20.1616 17.5845 21.5243C17.5845 22.8869 18.6705 24 20.0005 24C21.3305 24 22.417 22.8869 22.417 21.5243C22.417 20.1616 21.3305 19.049 20.0005 19.049ZM20.0005 19.8174C20.9252 19.8174 21.667 20.5769 21.667 21.5243C21.667 22.4716 20.9252 23.2316 20.0005 23.2316C19.0758 23.2316 18.3345 22.4716 18.3345 21.5243C18.3345 20.5769 19.0758 19.8174 20.0005 19.8174Z" fill="#30C223"/>
      ...
      $("td:eq(8)", row).html(
        `       <div class="flex justify-between">
                                ...
                                <button onclick="window.location='officedetails.html'" class="block relative ml-3 duration-500 details">
...
${elememt}
  ...
  h1.innerText = "تقارير الاشتراكات";
