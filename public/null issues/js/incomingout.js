  ...
  var table = $("#myTable").DataTable({
    ...
    createdRow: function (row, data, dataIndex) {
      $("td:eq(5)", row).html(
        `       <div>
                                <button type="button"
                                    class="  border-[#8C7155] border but text-[#8C7155]  hover:bg-black duration-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mt-3  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">+
                                    المعاملة</button>
...
$(document).ready(function (e) {
  var table = $("#myTable2").DataTable({
    ...
    ordering: false,
    info: false,
    dom: "<''<'top flex justify-between   mb-3 mx-5 flex-wrap sm:flex-nowrap mt-10' <'div1'><'div2'> <'div3'> <'block mt-3'l>> <'relative  w-full mx-auto  overflow-x-auto  w-full 'rt>><'bottom flex relative botton-1 py-4 rounded-b-xl w-full bg-white border-b mx-4 ' <'ml-auto mt-2     custom-page-number' p>>",
  });
...
تاريخها:</h3>
  ...
  $(".div3").html(`
            <div class="text-right">
                                    <h3 
                                        class="text-lg mb-1 md:cursor-default cursor-pointer font-medium text-gray-500 dark:text-gray-400">الموضوع:</h3>

                                    <a
                                        class="text-[#0D0C22] transition-colors  duration-200 dark:text-gray-200  dark:hover:text-blue-400   ">استدعاء....</a>
                                </div>
  `);
