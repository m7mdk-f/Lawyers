...
$(document).ready(function (e) {
  ...
  var table2 = $("#myTable3").DataTable({
    ...
    createdRow: function (row, data, dataIndex) {
      $("td:eq(4)", row).html(
        `       <div class="flex ">
                                <button onclick="window.location='./Ongoing issues/detailsjarya.html'"
                                 class="block relative hover:bg-black hover:text-white bg-[#4AC18E] text-white px-5 rounded-md py-2  duration-500  ml-3">موافقة

                        </button>
                                       <button  onclick="window.location='./Ongoing issues/detailsjarya.html'" class="block border-[#EA553D] hover:bg-black hover:text-white  border px-5 py-2  rounded-md text-[#EA553D] relative duration-500 ">
                رفض
                            </button>
                            </div>`
      );
  ...
  h1.innerText = "قضايا بانتظار اعادة فتحها";
