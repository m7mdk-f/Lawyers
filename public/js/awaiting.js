...
$(document).ready(function (e) {
  ...
  var table2 = $("#myTable3").DataTable({
    ...
    createdRow: function (row, data, dataIndex) {
      $("td:eq(8)", row).html(
        `       <div class="flex ">
                                <button onclick="window.location='./Finance.html'"
                                 class="block relative bg-[#4AC18E] hover:bg-black hover:text-white  text-white px-5 rounded-md py-2  duration-500  ml-3">موافقة

                        </button>
                                       <button  onclick="window.location='./Finance.html'" class="block border-[#EA553D] hover:bg-black hover:text-white  border px-5 py-2  rounded-md text-[#EA553D] relative duration-500 ">
                رفض
                            </button>
                            </div>`
      );
  ...
  h1.innerText = "سندات قضايا بانتظار الاعتماد";
